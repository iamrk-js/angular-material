export const COURSES: any = {
  ...
  11: {
    ...
    iconUrl: 'https://github.com/iamrk-js/imagesForMaterial/blob/main/angular-material-course-1.jpg',
    category: 'BEGINNER',
    seqNo: 0,
  ...
  19: {
    ...
    iconUrl: 'https://github.com/iamrk-js/imagesForMaterial/blob/main/angular-forms-course-small.jpg',
    courseListIcon: 'https://github.com/iamrk-js/imagesForMaterial/blob/main/main-page-logo-small-hat.png',
    category: 'BEGINNER',
    lessonsCount: 10,
    seqNo: 1,
  ...
  18: {
    ...
    iconUrl: 'https://github.com/iamrk-js/imagesForMaterial/blob/main/angular-router-course.jpg',
    courseListIcon: 'https://github.com/iamrk-js/imagesForMaterial/blob/main/main-page-logo-small-hat.png',
    category: 'BEGINNER',
    lessonsCount: 10,
    seqNo: 2,
  ...
  17: {
    ...
    iconUrl: 'https://github.com/iamrk-js/imagesForMaterial/blob/main/reactive-angular-course.jpg',
    courseListIcon: 'https://github.com/iamrk-js/imagesForMaterial/blob/main/main-page-logo-small-hat.png',
    category: 'BEGINNER',
    lessonsCount: 10,
    seqNo: 3,
  ...
  3: {
    ...
    iconUrl: 'https://github.com/iamrk-js/imagesForMaterial/blob/main/rxjs-in-practice-course.png',
    courseListIcon: 'https://github.com/iamrk-js/imagesForMaterial/blob/main/main-page-logo-small-hat.png',
    category: 'BEGINNER',
    lessonsCount: 10,
    seqNo: 4,
  ...
  4: {
    ...
    iconUrl: 'https://github.com/iamrk-js/imagesForMaterial/blob/main/ngrx-v2.png',
    category: 'BEGINNER',
    lessonsCount: 10,
    seqNo: 5,
    url: 'ngrx-course',
  ...
  2: {
    ...
    iconUrl: 'https://github.com/iamrk-js/imagesForMaterial/blob/main/angular-core-in-depth-small.png',
    lessonsCount: 10,
    category: 'BEGINNER',
    seqNo: 6,
  ...
  12: {
    ...
    iconUrl: 'https://github.com/iamrk-js/imagesForMaterial/blob/main/angular-testing-small.png',
    category: 'BEGINNER',
    seqNo: 8,
  ...
  1: {
    ...
    iconUrl: 'https://github.com/iamrk-js/imagesForMaterial/blob/main/serverless-angular-small.png',
    lessonsCount: 10,
    category: 'BEGINNER',
    seqNo: 9,
  ...
  16: {
    ...
    iconUrl: 'https://github.com/iamrk-js/imagesForMaterial/blob/main/stripe-course.jpg',
    lessonsCount: 10,
    category: 'BEGINNER',
    seqNo: 10,
    url: 'stripe-course',
  ...
  14: {
    ...
    iconUrl: 'https://github.com/iamrk-js/imagesForMaterial/blob/main/nestjs-v2.png',
    category: 'BEGINNER',
    lessonsCount: 10,
    seqNo: 11,
    url: 'nestjs-course',
  ...
  6: {
    ...
    iconUrl: 'https://github.com/iamrk-js/imagesForMaterial/blob/main/security-cover-small-v2.png',
    courseListIcon: 'https://github.com/iamrk-js/imagesForMaterial/blob/main/lock-v2.png',
    category: 'ADVANCED',
    lessonsCount: 11,
    seqNo: 12,
  ...
  7: {
    ...
    iconUrl: 'https://github.com/iamrk-js/imagesForMaterial/blob/main/angular-pwa-course.png',
    courseListIcon: 'https://github.com/iamrk-js/imagesForMaterial/blob/main/alien.png',
    category: 'ADVANCED',
    lessonsCount: 8,
    seqNo: 14,
...
export const USERS = {
  1: {
    ...
    password: 'test',
    pictureUrl: 'https://github.com/iamrk-js/imagesForMaterial/blob/main/main-page-logo-small-hat.png'
  }
